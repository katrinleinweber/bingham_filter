...
num_normals_to_fit = round(size(normals,2));
min_point_bmm_fit = round(0.05*num_normals_to_fit);
...
% options.algorithm = 'gaussnewton';

[bmm, bmm_weights] = BinghamDistribution.cluster_fit(normals_to_fit_bmm, min_point_bmm_fit, options);
